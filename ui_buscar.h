...
**
** Created: Sat Jun 23 04:38:48 2012
...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        Dialog->resize(614, 469);
        pushButton = new QPushButton(Dialog);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(540, 70, 51, 23));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Imagenes/VLC.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"font: bold;"));
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Imagenes/puerta.jpeg"), QSize(), QIcon::Normal, QIcon::Off);
