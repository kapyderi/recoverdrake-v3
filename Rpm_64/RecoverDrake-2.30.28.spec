...
Summary(es): Tuneando los rpm's de tu Mandriva and Mageia
Version: 2.30.28 
Release: 1bdk
License: GPL v2	
Group: File tools
...
%changelog
* Wed Jun 25 2012 <kapyder@eresmas.com> %{version}-%{release}
- Bugs corregidos.
...
- Bugs corregidos.
- Menu de administrador (no para usuarios).

* Sat Jun 8 2012 <kapyder@eresmas.com> %{version}-%{release}
- Bugs corregidos.
