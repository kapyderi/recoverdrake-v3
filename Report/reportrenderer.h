...
public:
    ...
    QDomDocument render(QPrinter* printer ,QDomDocument in ,QMap<QString,QString> queryClausules, QMap<QString, QString> params, bool& error, bool isPrev);
...
private:
    ...
    QPair<QString, QString> getSql(QString,QMap<QString,QString> queryClausules, bool prev);
    ...
    QDomDocument preRender(QPainter *painter, QDomDocument in , QMap<QString,QString> queryClausules, QMap<QString, QString> params, bool& error, bool isPrev);
    QDomDocument m_doc;
    QDomDocument DocIn;
