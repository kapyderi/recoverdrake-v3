...
Summary(es): Tuneando los rpm's de tu Mandriva y Mageia 
Version: 1.6.0 
Release: 3bdk.2010.1
License: GPL v2
Group: File tools
...
RecoverDrake is also used to fix some Mandriva sections and solve known bugs.
...
Tambien sirve para "maquear" algunas partes de Mandriva y solución a
problemas "conocidos"
...
install -m0755 $RPM_BUILD_DIR/%{name}-%{version}/Miscelanea.db.sqlite $RPM_BUILD_ROOT/usr/share/RecoverDrake/Miscelanea.RecoverDrake.db.sqlite
...
%changelog
* Sat Feb 26 2011 <kapyder@eresmas.com> %{version}-%{release}
- Bugs corregidos.
