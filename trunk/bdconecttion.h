...
{    
    ...
    {        
        ...
        if (file.exists() == false)
        {
            ...
            if (file1.exists() == false)
            {
                if (locale == "es")
                    ...
                    m.setText("This is the first time you use RecoverDrake so you create a database with the default settings.");
                m.exec();
        ...
        if (!db.open())
        {
            if (locale == "es")
                ...
                m.setText("<b>Fatal error</b>:<p>It has not been able to open the database configuration required<p>Check that there Miscelanea.RecoverDrake.db.sqlite in the path /usr/share/RecoverDrake.");
            m.exec();
            return false;
        }
        else if (!DB.open())
        {
            if (locale == "es")
                ...
                m.setText("<b>Fatal error</b>:<p>It has not been able to open the mirror database configuration required<p>Check that there Miscelanea.RecoverDrake.db.sqlite in the path /usr/share/RecoverDrake.");
            m.exec();
            return false;
        }
        else if (!SM.open())
        ...
        else
        {
           ...
           else if (Usu != Ver)
           {
                int respuesta = 0;
                {
                    if (idioma == "en")
                    {
                        respuesta = QMessageBox::question(0,QString::fromUtf8("New version of RecoverDrake"),
                                           QString::fromUtf8("<center><b>New version of RecoverDrake located on the computer<b></center><p>"
                                           "I've found that you have recently installed a new version of "
                                           "RecoverDrake <b>("+Ver+")</b> and can update your data from previous versions or create a database with the minimum.<p>"
                                           "<B>NOTE: We recommend that you upgrade to keep settings and data created by you.</B><p>"
                                           "Upgrade database to latest version?"), QMessageBox::Ok, QMessageBox::No);
                    }
                    else
                    {
                ...
                {
                    QString Trans1, Trans2, Trans3;
                    if (idioma == "en")
                    {
                        Trans1="Old database .sqlite";
                        Trans2="sqlite file (*.sqlite)";
                    }
                    else
                    {
                        Trans1="Base de datos antigua .sqlite";
                        Trans2="Fichero .sqlite (*.sqlite)";
                    }
                    QString path="/usr/share/RecoverDrake/";
                    QString fileNameOrigen = QFileDialog::getOpenFileName(0,Trans1,path,Trans2);
                    ...
                    if (idioma == "en")
                    {
                        Trans1="Found new version ";
                        Trans2=", updating database RecoverDrake... Please wait";
                        Trans3="Cancel";
                    }
                    else
                    {
                        Trans1="Encontrada nueva version ";
                        Trans2=", actualizando Base de datos de RecoverDrake... Espera por favor";
                        Trans3="Cancelar";
                    }
                    QProgressDialog progress(Trans1+Ver+Trans2, Trans3, 0, 52);
                    ...
                    for(int i=0;i<52;i++ )
                    {
                        ...
                        if (i==4)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating blacklist ip... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando lista negra de ip's... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                        ...
                        if (i==5)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating whitelist ip... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando lista blanca de ip's... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==6)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list if keywords... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando lista de palabras clave... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==13)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating songs list... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando lista de canciones... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==15)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of radio channels... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando lista de canales de radio... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==16)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of TV channels... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando lista de canales de television... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==18)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating users... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando usuarios... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==20)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating access control... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando control de accesos... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==25)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating menus... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando menus... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==28)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating movies catalog... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando catalogo de peliculas... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressPelis(Trans2, Trans3, 0, cuenta);
                        ...
                        if (i==30)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating ip allowed to VNC... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando Ip's permitidas para VNC... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==38)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating synchronization control... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando control de sincronizaciones... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==40)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating ID genres mp3... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando ID de generos de mp3... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i == 42)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of keys... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando listado de claves... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                                ...
                                while(wlistanegra.next())
                                {
                                     ...
                                     if (RecDat.isSelect())
                                     {
                                         QString ValIp = RecDat.value(6).toString();
                                         if (Ubicacion != ValIp)
                                         {
                                             QSqlQuery Wdark(DB);
                        ...
                        if (i == 43)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of ASCII codes... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando listado de codigos ASCII... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i == 46)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of BIC codes... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando listado de codigos BIC... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        if (i==47)
                        {
                            ...
                            if (queryA.isValid())
                            {
                                QString cantidad41, cantidad42;
                                QSqlQuery query39(db);
                                query39.exec("SELECT CheckVerContorno,CheckLimitarVista FROM Chequeos WHERE id=2");
                                query39.first();
                                if (query39.isValid())
                                {
                                     cantidad41=query39.value(0).toString();
                                     cantidad42=query39.value(1).toString();
                                     QSqlQuery red(DB);
                                     red.exec("UPDATE Chequeos SET CheckVerContorno='"+cantidad41+"',CheckLimitarVista='"+cantidad42+"' WHERE id=2");
                                }
                            }
                        }
                        if (i == 48)
                        {
                            ...
                            {
                                QSqlQuery wlistanegr(db);
                                wlistanegr.exec("SELECT COUNT(report_id) as Cantidad FROM Report");
                                int cuenta, comienzo;
                                wlistanegr.first();
                                cuenta = wlistanegr.value(0).toInt();
                                QSqlQuery wlistanegra(db);
                                wlistanegra.exec("SELECT report_name,report_descrip,report_source,report_grade,report_table FROM Report");
                                if (idioma == "en")
                                {
                                    Trans2="Updating reports... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando reportes... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                                ...
                                while(wlistanegra.next())
                                {
                                     ...
                                     if (progressMenu.wasCanceled())
                                         break;
                                     QString DatName = wlistanegra.value(0).toString();
                                     QString DatDescrip = wlistanegra.value(1).toString();
                                     QString DatSource = wlistanegra.value(2).toString();
                                     int DatGrade = wlistanegra.value(3).toInt();
                                     QString DatTabla = wlistanegra.value(4).toString();
                                     QSqlQuery RecDat(DB);
                                     RecDat.exec("SELECT report_name,report_descrip,report_source,report_grade,report_table FROM Report WHERE report_name='"+DatName+"'");
                                     RecDat.first();
                                     if (RecDat.isSelect())
                                     {
                                         QString ValIp = RecDat.value(1).toString();
                                         ...
                                         {
                                             QSqlQuery Wdark(DB);
                                             Wdark.prepare("INSERT INTO Report (report_name,report_descrip,report_source,report_grade,report_table)"
                                                           "VALUES (:report_name,:report_descrip,:report_source,:report_grade,:report_table)");
                                             Wdark.bindValue(":report_name", DatName);
                                             Wdark.bindValue(":report_descrip", DatDescrip);
                                             Wdark.bindValue(":report_source", DatSource);
                                             Wdark.bindValue(":report_grade", DatGrade);
                                             Wdark.bindValue(":report_table", DatTabla);
                                             Wdark.exec();
                                         }
                                         else
                                         {
                        ...
                        if (i == 49)
                        {
                            ...
                            {
                                QSqlQuery wlistanegr(db);
                                wlistanegr.exec("SELECT COUNT(id) as Cantidad FROM Smtp");
                                int cuenta, comienzo;
                                wlistanegr.first();
                                cuenta = wlistanegr.value(0).toInt();
                                QSqlQuery wlistanegra(db);
                                wlistanegra.exec("SELECT Correo,smptserver,Clave,Autenticacion,SSL,User,Port FROM Smtp");
                                if (idioma == "en")
                                {
                                    Trans2="Updating emails... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando emails... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                                ...
                                while(wlistanegra.next())
                                {
                                     ...
                                     QString DatDescrip = wlistanegra.value(1).toString();
                                     QString DatSource = wlistanegra.value(2).toString();
                                     QString DatGrade = wlistanegra.value(3).toString();
                                     QString DatTabla = wlistanegra.value(4).toString();
                                     QString DatUser = wlistanegra.value(5).toString();
                                     QString DatPort = wlistanegra.value(6).toString();
                                     QSqlQuery RecDat(DB);
                                     RecDat.exec("SELECT Correo,smptserver,Clave,Autenticacion,SSL,User,Port FROM Smtp WHERE Correo='"+DatName+"'");
                                     RecDat.first();
                                     if (RecDat.isSelect())
                                     {
                                         QString ValIp = RecDat.value(1).toString();
                                         if (DatName != ValIp)
                                         {
                                             ...
                                             Wdark.bindValue(":Correo", DatName);
                                             Wdark.bindValue(":smptserver", DatDescrip);
                                             Wdark.bindValue(":Clave", DatSource);
                                             Wdark.bindValue(":Autenticacion", DatGrade);
                                             Wdark.bindValue(":SSL", DatTabla);
                                             Wdark.bindValue(":User", DatUser);
                                             Wdark.bindValue(":Port", DatPort);
                                             Wdark.exec();
                                         }
                                         else
                                         {
                        ...
                        {
                            QSqlQuery queryA(SM);
                            queryA.exec("SELECT count() FROM sqlite_master WHERE type='table' AND name='IdiomaES'");
                            queryA.first();
                            if (queryA.isValid())
                            {
                                QSqlQuery wlistanegr(db);
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of lenguage #1... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando listado de idiomas Nº1... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
                        ...
                        {
                            QSqlQuery queryA(SM);
                            queryA.exec("SELECT count() FROM sqlite_master WHERE type='table' AND name='IdiomaEN'");
                            queryA.first();
                            if (queryA.isValid())
                            {
                                QSqlQuery wlistanegr(db);
                                ...
                                if (idioma == "en")
                                {
                                    Trans2="Updating list of lenguage #2... Please wait";
                                    Trans3="Cancel";
                                }
                                else
                                {
                                    Trans2="Actualizando listado de idiomas Nº2... Espera por favor";
                                    Trans3="Cancelar";
                                }
                                QProgressDialog progressMenu(Trans2, Trans3, 0, cuenta);
                                progressMenu.setWindowModality(Qt::WindowModal);
    ...
    else
    {
        if (locale == "es")
            ...
            m.setText("No driver installed. Check the availability of the database.");
        m.exec();
        return false;
    }
    return false;
